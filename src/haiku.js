export class Haiku {
  ...
  syllableChecker1() {
    let regex = /[aeiou]dge\b|eau|[cg]eous|[cgt]ious|qu[aeiou]{1,2}|[^aeiou]le\b|[^aeiou]les\b|[a-z]{2,3}es\b|[a-z]{2,3}e\b|ia|ai|ay|ee|ea|ie|ei|oo|ou|ow|oe|oo|ue|ey|ay|oy|oi|au|aw|y\b|[aeiou]/g;
  ...
  isAHaiku() {
    if ((this.syllableChecker1() === true) && (this.syllableChecker2()=== true) && (this.syllableChecker3() === true)) {
      ...
      return true + (" Its a Hiaku!!!");
    } else {

      return false + (" this is not correct");
    }
  }
}
